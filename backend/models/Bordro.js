...
const bordroSchema = new mongoose.Schema(
  {
    ...
    // Çalışan onay bilgileri (eski email sistemi - geriye dönük uyumluluk)
    ...
    // SMS doğrulama bilgileri (yeni sistem)
    employeeApprovalPhone: {
      type: String, // SMS gönderilen telefon numarası
    },
    smsVerification: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'SmsVerification',
    ...
    approvalMethod: {
      type: String,
      enum: ['email', 'sms'],
      default: 'sms', // Yeni varsayılan SMS
    },
