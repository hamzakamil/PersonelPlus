    ...
    <div class="flex justify-end items-center mb-6">
      <div class="flex items-center gap-4">
        ...
        <button
          ...
          :class="isFullscreen ? 'bg-blue-100 border-blue-400 text-blue-700' : ''"
          :title="isFullscreen ? 'Normal görünüme dön (ESC)' : 'Tam ekran'"
        >
          <svg
            v-if="!isFullscreen"
            class="w-5 h-5"
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showRetiredStatus"
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showDepartment"
                  class="w-4 h-4 text-blue-600 rounded"
                />
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showHireDate"
                  class="w-4 h-4 text-blue-600 rounded"
                />
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showTcKimlik"
                  class="w-4 h-4 text-blue-600 rounded"
                />
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showDayOvertime"
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showNightOvertime"
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showAdvanceDeduction"
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showTotalDays"
                  class="w-4 h-4 text-blue-600 rounded"
                />
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showSgkGun"
                  class="w-4 h-4 text-indigo-600 rounded"
                />
                <span class="text-sm text-gray-700">Çalışma & SGK Günü</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="displaySettings.showExtraPayments"
                ...
                <div class="space-y-1 max-h-32 overflow-y-auto">
                  ...
                  >
                    ...
                    <span class="text-xs text-gray-600">{{
                      cpt.paymentType?.name || cpt.customName
                    }}</span>
                  </label>
                </div>
              </div>
        ...
        <table class="min-w-full">
          <thead class="bg-gray-50">
            <tr>
              ...
              <!-- Emekli Durumu -->
              <th
                v-if="displaySettings.showRetiredStatus"
                class="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-orange-50"
                title="Emekli Durumu"
              >
              ...
              <!-- Departman -->
              <th
                v-if="displaySettings.showDepartment"
                class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase bg-purple-50"
                title="Departman"
              >
                Dept.
              </th>
              <!-- İşe Giriş Tarihi -->
              <th
                v-if="displaySettings.showHireDate"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-blue-50"
              ...
              <!-- TC Kimlik -->
              <th
                v-if="displaySettings.showTcKimlik"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-gray-100"
                title="TC Kimlik No"
              >
                TC Kimlik
              </th>
              ...
              <th
                v-if="displaySettings.showTotalDays"
                class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-gray-100"
              >
                Toplam
              </th>
              <!-- Çalışma Günü & SGK Günü -->
              <th
                v-if="displaySettings.showSgkGun"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-emerald-50"
                title="Çalışma Günü"
              >
                <div class="text-emerald-700">Çalışma</div>
                <div class="text-[10px]">Günü</div>
              </th>
              <th
                v-if="displaySettings.showSgkGun"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-indigo-50"
                title="SGK Günü (düzenlenebilir)"
              >
                <div class="text-indigo-700">SGK</div>
                <div class="text-[10px]">Günü</div>
              </th>
              <th
                v-if="displaySettings.showDayOvertime"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-orange-50"
                title="Fazla Mesai (Gündüz) - Saat"
              >
              ...
              <th
                ...
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-gray-700 text-white"
                title="Gece Mesaisi - Saat"
              >
                <div class="flex items-center justify-center gap-1">
              ...
              <th
                ...
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-red-600 text-white"
                title="Avans Kesintisi (TL)"
              >
                <div class="flex items-center justify-center gap-1">
              ...
              <!-- Ek Ödemeler -->
              <th
                v-if="displaySettings.showExtraPayments"
                class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase bg-green-600 text-white"
                title="Ek Ödemeler"
              >
                <div>Ek</div>
            ...
            <tr v-for="item in puantajList" :key="item.employee._id" class="hover:bg-gray-50">
              ...
              >
                ...
                <div class="text-xs text-gray-500">
                  {{ item.employee.personelNumarasi || item.employee.employeeNumber }}
                </div>
              </td>
              <!-- Emekli Durumu -->
              <td
                v-if="displaySettings.showRetiredStatus"
                class="px-2 py-2 text-center bg-orange-50"
              >
                <span
                  v-if="item.employee.isRetired"
              ...
              <td
                v-if="displaySettings.showDepartment"
                class="px-3 py-2 text-xs bg-purple-50 max-w-[100px] truncate"
                :title="item.employee.department?.name"
              >
              ...
              <td
                v-if="displaySettings.showHireDate"
                class="px-3 py-2 text-center text-xs bg-blue-50"
              >
              ...
              <td
                v-if="displaySettings.showTcKimlik"
                class="px-3 py-2 text-center text-xs bg-gray-100 font-mono"
              >
              ...
              <td v-if="displaySettings.showTotalDays" class="px-4 py-2 text-center bg-gray-50">
                <div class="text-xs">
                  <span class="text-green-600 font-medium"
                    >{{ formatDays(item.puantaj.summary?.normalDays) }}N</span
                  >
                  <span class="text-blue-600 ml-1"
                    >{{ formatDays(item.puantaj.summary?.weekendDays) }}H</span
                  >
                  <span class="text-purple-600 ml-1"
                    >{{ formatDays(item.puantaj.summary?.publicHolidays) }}T</span
                  >
                  <span class="text-yellow-600 ml-1"
                    >{{ formatDays(item.puantaj.summary?.annualLeaveDays) }}S</span
                  >
                  <span v-if="item.puantaj.summary?.halfDays > 0" class="text-orange-500 ml-1"
                    >{{ formatDays(item.puantaj.summary?.halfDays) }}Y</span
                  >
                </div>
              </td>
              <!-- Çalışma Günü (readonly) -->
              <td v-if="displaySettings.showSgkGun" class="px-3 py-2 text-center bg-emerald-50">
                <span class="text-sm font-bold text-emerald-700">{{
                  formatDays(getCalismaGunu(item.puantaj))
                }}</span>
              </td>
              <!-- SGK Günü (düzenlenebilir) -->
              <td v-if="displaySettings.showSgkGun" class="px-1 py-1 text-center bg-indigo-50">
                <input
                  type="number"
                  :value="getSgkGun(item.puantaj)"
                  @blur="saveSgkGun(item, $event.target.value)"
                  @keyup.enter="$event.target.blur()"
                  class="w-14 px-1 py-1 text-sm font-bold text-center text-indigo-700 bg-white border border-indigo-200 rounded focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
                  step="0.5"
                  min="0"
                  max="31"
                />
              ...
              >
                <div
                  v-if="getTotalCombinedDayOvertime(item.puantaj) > 0"
                ...
                >
                  <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm font-bold text-orange-700">{{
                      getTotalCombinedDayOvertime(item.puantaj)
                    }}</span>
                  </div>
                  <div
                    v-if="item.puantaj?.manualOvertime?.dayOvertimeHours > 0"
                    class="text-[9px] text-orange-500"
                  >
                ...
                <div v-else class="text-gray-400 text-xs hover:text-orange-500">
                  <span
                    v-if="getPendingDayOvertimeCount(item.employee._id)"
              ...
              >
                <div
                  v-if="getTotalCombinedNightOvertime(item.puantaj) > 0"
                  class="flex flex-col items-center justify-center"
                >
                  <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm font-bold text-white">{{
                      getTotalCombinedNightOvertime(item.puantaj)
                    }}</span>
                  </div>
                  <div
                    v-if="item.puantaj?.manualOvertime?.nightOvertimeHours > 0"
                ...
                <div v-else class="text-gray-400 text-xs hover:text-gray-300">
                  <span
                    v-if="getPendingNightOvertimeCount(item.employee._id)"
              ...
              >
                <div
                  v-if="getEmployeeAdvanceDeduction(item.puantaj) > 0"
                ...
                >
                  ...
                  <span class="text-sm font-bold text-red-700">{{
                    formatCurrency(getEmployeeAdvanceDeduction(item.puantaj))
                  }}</span>
                </div>
              ...
              >
                <span
                  v-if="getEmployeePaymentAmount(item.employee._id, cpt._id)"
              ...
              <td
                v-if="displaySettings.showExtraPayments"
                class="px-2 py-1 text-center bg-green-50"
              >
                <button
                ...
                >
                  <div
                    v-if="getEmployeePaymentSummary(item.employee._id)"
                  ...
                  <div v-else class="text-gray-400 text-[10px]">+ Ekle</div>
                </button>
              </td>
            </tr>
          </tbody>
          ...
          <div v-else>
              ...
              <div class="space-y-3">
                <div>
                  ...
                  >
                    ...
                    <option v-for="cpt in availablePaymentTypes" :key="cpt._id" :value="cpt._id">
                      {{ cpt.paymentType?.name || cpt.displayName }} -
                      {{ formatCurrency(cpt.defaultAmount) }}
                    </option>
                  </select>
                </div>
            ...
            <div class="space-y-2">
              <div
                ...
                :class="
                  payment.isActive ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'
                "
              >
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        :class="
                          payment.isActive ? 'bg-green-500 text-white' : 'bg-gray-400 text-white'
                        "
                      >
                    ...
                    <div class="text-xs text-gray-500 mt-0.5">
                      ...
                      <span v-if="payment.endDate">
                        - Bitiş: {{ formatDate(payment.endDate) }}</span
                      >
                    </div>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="text-right">
                      <div class="text-sm font-semibold text-green-700">
                        {{
                          formatCurrency(
                            payment.amount || payment.companyPaymentType?.defaultAmount
                          )
                        }}
                      </div>
            ...
            <!-- Toplam -->
            <div
              v-if="employeePaymentsList.length > 0"
            ...
            >
              ...
              <span class="text-sm font-bold text-green-700">{{
                formatCurrency(employeePaymentsTotal)
              }}</span>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              >
                {{ selectedOvertimeType === 'DAY' ? 'Fazla Mesai' : 'Gece Mesaisi' }} -
                {{ getMonthName(selectedMonth) }} {{ selectedYear }}
              </p>
            </div>
          </div>
        ...
        <div class="flex-1 overflow-y-auto p-4">
          ...
          <div v-else>
            <!-- Bilgi Notu -->
            <div
              class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200 text-xs text-blue-700"
            >
              <div class="flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                ...
                <span
                  >Fazla mesai talepleri çalışanlar tarafından oluşturulur. Yöneticiler burada
                  talepleri onaylayabilir veya reddedebilir.</span
                >
              </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-3">
                    <div class="text-right">
                      <div
                        class="text-sm font-semibold"
                        :class="req.status === 'APPROVED' ? 'text-green-700' : 'text-gray-700'"
                      >
                        {{
                          req.status === 'APPROVED' && req.approvedHours
                            ? req.approvedHours
                            : req.requestedHours
                        }}
                        saat
                      ...
                      <div
                        v-if="req.status === 'APPROVED' && req.approvedHours !== req.requestedHours"
                        class="text-[9px] text-gray-400"
                      >
              ...
              <!-- Boş Durum -->
              <div
                v-if="filteredOvertimeRequests.length === 0"
                class="text-center py-6 text-gray-500"
              >
                <svg
                  v-if="selectedOvertimeType === 'DAY'"
                  class="w-10 h-10 mx-auto mb-2 text-orange-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p class="text-xs">
                  Bu ay için
                  {{ selectedOvertimeType === 'DAY' ? 'fazla mesai' : 'gece mesaisi' }} talebi yok
                </p>
              </div>
            </div>
    ...
    >
      <div class="bg-white rounded-lg p-6 w-full max-w-md">
        <h3 class="text-lg font-bold mb-4">
          {{ editingItem?.employee.firstName }} {{ editingItem?.employee.lastName }} -
          {{ editingDay }} {{ getMonthName(selectedMonth) }}
        </h3>
        ...
        <div class="p-5">
          ...
          <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200 text-xs text-blue-700">
            <div class="flex items-start gap-2">
              ...
              <span
                >Bu alana girilen mesai saatleri, belirli bir güne bağlı olmaksızın aylık toplam
                olarak kaydedilir. Puantaj hesaplamalarına eklenir.</span
              >
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="flex items-center gap-3">
              <input
                ...
                :class="
                  selectedOvertimeType === 'DAY' ? 'focus:ring-orange-500' : 'focus:ring-gray-500'
                "
                placeholder="0"
              />
...
const toggleFullscreen = () => {
  ...
  layoutFullscreen.value = isFullscreen.value;
};
...
onBeforeUnmount(() => {
  ...
  // Sayfadan ayrılırken fullscreen'i kapat
  layoutFullscreen.value = false;
});
...
const displaySettings = ref({
  ...
  showSgkGun: true, // Çalışma günü & SGK günü
...
// ==================== SGK GÜNÜ ====================
// Çalışma günü hesapla (normalDays)
const getCalismaGunu = puantaj => {
  return puantaj?.summary?.normalDays ?? 0;
};

// SGK günü değerini al (manuel set edilmişse onu, yoksa çalışma gününü döndür)
const getSgkGun = puantaj => {
  if (puantaj?.sgkGun !== null && puantaj?.sgkGun !== undefined) {
    return puantaj.sgkGun;
  }
  return getCalismaGunu(puantaj);
};

// SGK gününü kaydet
const saveSgkGun = async (item, value) => {
  try {
    const employeeId = item.employee._id;
    const puantaj = item.puantaj;
    const numValue = parseFloat(value);
    if (isNaN(numValue) || numValue < 0) return;

    await api.put(
      `/puantaj/employee/${employeeId}/${selectedYear.value}/${selectedMonth.value}/sgk-gun`,
      {
        sgkGun: numValue,
      }
    );
    // Lokal veriyi güncelle
    puantaj.sgkGun = numValue;
  } catch (error) {
    console.error('SGK günü kaydedilemedi:', error);
    toast.error('SGK günü kaydedilemedi');
  }
};
...
const loadPuantaj = async () => {
  ...
  try {
    ...
    const response = await api.get(
      `/puantaj/company/${companyId}/${selectedYear.value}/${selectedMonth.value}`
    );
...
const saveDayChange = async () => {
  try {
    ...
    // Listeyi güncelle
    const index = puantajList.value.findIndex(
      p => p.employee._id === editingItem.value.employee._id
    );
    if (index !== -1) {
...
const regenerateAll = async () => {
  ...
  try {
    ...
    toast.success(
      regenerateData.message || response.data?.message || 'Puantajlar yeniden hesaplandı'
    );
  } catch (error) {
...
const getAdvanceDeductionTooltip = puantaj => {
  ...
  const lines = deductions.map(
    d => d.description || `Avans Kesintisi: ${formatCurrency(d.amount)}`
  );
  return lines.join('\n');
};
...
const loadAllOvertimeSummary = async () => {
  try {
    ...
    const response = await api.get(
      `/overtime-requests/summary/${companyId}/${selectedYear.value}/${selectedMonth.value}`
    );
...
const loadOvertimeRequests = async employeeId => {
  try {
    ...
    const response = await api.get(
      `/overtime-requests/employee/${employeeId}?year=${selectedYear.value}&month=${selectedMonth.value}`
    );
