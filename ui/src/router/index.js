    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { roles: ['super_admin', 'bayi_admin', 'company_admin', 'resmi_muhasebe_ik', 'employee', 'hr_manager', 'department_manager'] }
        },
        {
        ...
        },
        {
          ...
          meta: { roles: ['super_admin', 'bayi_admin', 'company_admin', 'resmi_muhasebe_ik', 'hr_manager', 'department_manager'] }
        },
        {
          path: 'notifications',
          name: 'Notifications',
...
router.beforeEach((to, from, next) => {
  ...
  if (to.name === 'ActivateCompany' || to.name === 'ActivateEmployee' || to.name === 'ActivateAccount') {
    next()
    return
  }
